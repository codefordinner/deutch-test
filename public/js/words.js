(function () {
  ...
  var LEVEL_NAMES = window.WordsSRS ? window.WordsSRS.LEVEL_NAMES : {};
  function normalize(s) { return window.WordsSRS ? window.WordsSRS.normalize(s) : s; }
  function matchesAnyAlternative(userInput, correctText) { return window.WordsSRS ? window.WordsSRS.matchesAnyAlternative(userInput, correctText) : false; }

  // ===== SRS / LEITNER SYSTEM ENGINE (DELEGATED) =====

  function getWordSRS(wordId, keyOrDir) { return window.WordsSRS ? window.WordsSRS.getWordSRS(wordId, keyOrDir) : {}; }
  function updateWordSRS(wordId, keyOrDir, isCorrect) { return window.WordsSRS ? window.WordsSRS.updateWordSRS(wordId, keyOrDir, isCorrect) : {}; }
  function resetSRSProgress(categoryId) { if (window.WordsSRS) window.WordsSRS.resetSRSProgress(categories, categoryId, renderCategoryProgress, onSettingsChanged); }
  function getSelectedCategoryIds() { return window.WordsSRS ? window.WordsSRS.getSelectedCategoryIds() : []; }
  function getDirs() { return window.WordsSRS ? window.WordsSRS.getDirs() : []; }
  function getPool() { return window.WordsSRS ? window.WordsSRS.getPool(categories) : []; }
  function saveCategoriesSelection() { if (window.WordsSRS) window.WordsSRS.saveCategoriesSelection(); }
  function loadCategoriesSelection() { return window.WordsSRS ? window.WordsSRS.loadCategoriesSelection() : null; }
  function saveDirs() { if (window.WordsSRS) window.WordsSRS.saveDirs(); }
  function loadDirs() { if (window.WordsSRS) window.WordsSRS.loadDirs(); }
  function loadSmartEnabled() { return window.WordsSRS ? window.WordsSRS.loadSmartEnabled() : false; }
  function saveSmartEnabled(val) { if (window.WordsSRS) window.WordsSRS.saveSmartEnabled(val); }
  function loadSRSEnabled() { return window.WordsSRS ? window.WordsSRS.loadSRSEnabled() : true; }
  function saveSRSEnabled(val) { if (window.WordsSRS) window.WordsSRS.saveSRSEnabled(val); }
  ...
  function pickWordPlain(pool, lastWordId) { return window.WordsSRS ? window.WordsSRS.pickWordPlain(pool, lastWordId) : null; }

  function pickWordSRS(pool, dirs, lastWordId, isSmartEnabled) { return window.WordsSRS ? window.WordsSRS.pickWordSRS(pool, dirs, lastWordId, isSmartEnabled) : null; }
