...
(function () {
  ...
  var IRREGULAR_CONJUGATIONS = window.GermanVerbsData ? window.GermanVerbsData.IRREGULAR_CONJUGATIONS : {};

  function conjugateRegular(infinitive) {
    return window.GermanVerbsData ? window.GermanVerbsData.conjugateRegular(infinitive) : {};
  }
